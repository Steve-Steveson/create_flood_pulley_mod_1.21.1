...
public class FloodPulleyVisual extends AbstractPulleyVisual<FloodPulleyBlockEntity> {
    public FloodPulleyVisual(VisualizationContext dispatcher, FloodPulleyBlockEntity blockEntity, float partialTick) {
